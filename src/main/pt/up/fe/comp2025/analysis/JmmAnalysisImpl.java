...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    private List<AnalysisVisitor> buildPasses(SymbolTable table) {
        return List.of(new UndeclaredVariable(), new ArithmeticOperation(), new ArrayInit(), new ObjectCreation(), new ConditionCheck(), new Assignment(), new MethodDeclaration(), new FunctionCall());
    }
